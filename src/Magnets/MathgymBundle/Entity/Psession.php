...
/**
 * Magnets\MathgymBundle\Entity\Psession
 *
 * @ORM\Table(name="psessions")
 * @ORM\Entity(repositoryClass="Magnets\MathgymBundle\Entity\PsessionRepository")
 */
class Psession {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="User", inversedBy="psessions")
    ...
    public function __construct() {
        ...
        $this->setData(array(
            ...
            'hint1' => "Sample hint1: Think!",
            'hint2' => "Sample hint2: Add!",
            'solution' => "Sample solution: 2+2=4",
            'answer' => "4",
            'options' => "<ol>\n<li>First option</li>\n<li>Second option</li>\n<li>Third option</li>\n</ol>",
            'flags' => "1",
            'std' => 0,
